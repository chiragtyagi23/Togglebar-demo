  ...
  return (
    <Nav>
      <div className={menuIcon ? "navbar active" : "navbar" } >
        ...
        <IoMenu  name='menu-outline' className='mobile-nav-icon' onClick={()=> setMenuIcon(true)}/>
        <IoCloseSharp  name='close-outline' className='mobile-nav-icon close-outline' onClick={()=> setMenuIcon(false)}/>
        </div>
      </div>
    </Nav>
  )
